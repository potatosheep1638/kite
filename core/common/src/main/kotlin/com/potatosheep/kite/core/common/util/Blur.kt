...
private suspend fun Bitmap.blur(
    ...
    // Not null assertion is necessary in order to compile, or the compiler will throw a type
    // mismatch error. I do not know why this is the case. Might be related to compile SDK?
