...
val Icons.Rounded.FileDownload: ImageVector
    get() {
        if (_roundFileDownload != null) {
            return _roundFileDownload!!
        }
        _roundFileDownload = Builder(
            name = "RoundFileDownload", defaultWidth = 24.0.dp,
...
private var _roundFileDownload: ImageVector? = null
