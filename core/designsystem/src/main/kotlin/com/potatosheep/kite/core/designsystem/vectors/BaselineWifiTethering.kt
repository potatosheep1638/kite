...
val Icons.Rounded.BaselineWifiTethering: ImageVector
    get() {
        if (_baselineWifiTethering != null) {
            return _baselineWifiTethering!!
        }
        _baselineWifiTethering = Builder(name = "BaselineWifiTethering", defaultWidth = 24.0.dp,
...
private var _baselineWifiTethering: ImageVector? = null
