...
val Icons.Outlined.OutlinePublic: ImageVector
    get() {
        if (_outlinePublic != null) {
            return _outlinePublic!!
        }
        _outlinePublic = Builder(name = "OutlinePublic", defaultWidth = 24.0.dp, defaultHeight
...
private var _outlinePublic: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = Icons.Outlined.OutlinePublic, contentDescription = "")
    }
}
